public class FirePokemon extends Pokemon {
    ...
    public FirePokemon(int collectionNumber, String name, int grade, int pe, String zMove, String moveType) {
        super(collectionNumber, name, grade, pe, zMove, moveType, PokemonType.FIRE);
    }
    ...
    public double calculateAttackPower(Pokemon enemy, String attackType) {
        ...
        if (enemy.getType().equalsIgnoreCase("fire") || enemy.getType().equalsIgnoreCase("water"))
            finalAttackPower = attackPower * 0.5 - defendPower;
        else if (enemy.getType().equalsIgnoreCase("bug"))
