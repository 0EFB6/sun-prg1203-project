...
public class PokemonCollection {
	...
	public Pokemon[] getAllPokemon () {
	 ...
	 public  void initPokemonStats() {
	        pokemon[0].setStats(new Stats(15, 4, 4, 3, 3, 4));
	        pokemon[1].setStats(new Stats(20, 4, 5, 4, 4, 5));
	        pokemon[2].setStats(new Stats(15, 3, 3, 4, 4, 3));
	        pokemon[3].setStats(new Stats(20, 4, 4, 5, 5, 4));
	        pokemon[4].setStats(new Stats(25, 5, 5, 6, 7, 5));
	        pokemon[5].setStats(new Stats(15, 2, 2, 3, 2, 3));
	        pokemon[6].setStats(new Stats(15, 2, 2, 4, 2, 2));
	        pokemon[7].setStats(new Stats(10, 3, 1, 2, 1, 4));
	        pokemon[8].setStats(new Stats(10, 4, 2, 3, 3, 5));
	        pokemon[9].setStats(new Stats(10, 3, 2, 2, 2, 3));
	        pokemon[10].setStats(new Stats(15, 5, 3, 3, 3, 4));
	        pokemon[11].setStats(new Stats(15, 4, 3, 3, 3, 6));
	        pokemon[12].setStats(new Stats(20, 6, 6, 4, 5, 7));
	        pokemon[13].setStats(new Stats(10, 4, 1, 4, 1, 2));
	        pokemon[14].setStats(new Stats(15, 5, 2, 5, 2, 4));
	        pokemon[15].setStats(new Stats(15, 3, 3, 3, 2, 3));
	        pokemon[16].setStats(new Stats(25, 5, 5, 5, 6, 6));
	        pokemon[17].setStats(new Stats(25, 5, 6, 5, 5, 5));
	        pokemon[18].setStats(new Stats(15, 5, 7, 5, 5, 4));
	        pokemon[19].setStats(new Stats(10, 4, 2, 2, 2, 4));
	    }
}
