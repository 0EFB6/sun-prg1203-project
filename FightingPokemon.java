public class FightingPokemon extends Pokemon{
    ...
    public FightingPokemon(int collectionNumber, String name, int grade, int pe, String zMove, String moveType) {
        super(collectionNumber, name, grade, pe, zMove, moveType, PokemonType.FIGHTING);
    }
    ...
    public double calculateAttackPower(Pokemon enemy, String attackType) {
        ...
        if (enemy.getType().equalsIgnoreCase("poison") || enemy.getType().equalsIgnoreCase("bug"))
            finalAttackPower = attackPower * 0.5 - defendPower;
        else if (enemy.getType().equalsIgnoreCase("normal"))
