...
public class Catch {
    private int pokemonCollectionNumber;
    ...
    public Catch(int pokemonCollectionNumber, Pokeball pokeBall, boolean success, DropItem dropItem, Disk disk) {
        this.pokemonCollectionNumber = pokemonCollectionNumber;
    ...
    public int getPokemonCollectionNumber() {
        return pokemonCollectionNumber;
    }
    ...
    public void displayCatchInfo() {
        System.out.println("Pokemon Collection Number: " + pokemonCollectionNumber);
